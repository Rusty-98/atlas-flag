...
const Card = ({name, popu, region, capi, img}) => {
  return (
    <div className="w-64 h-auto bg-slate-400 overflow-hidden border-4 border-cyan-500 rounded-lg cursor-pointer hover:border-red-500 hover:scale-[1.02] ease-in-out">
